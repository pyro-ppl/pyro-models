# model file: ../example-models/misc/gaussian-process/gp-fit-logit.stan
import torch
import pyro
...
def validate_data_def(data):
    ...
    check_constraints(z, low=0, high=1, dims=[N])
...
def model(data, params):
    ...
    z =  _pyro_sample(z, "z", "bernoulli_logit", [_call_func("add", [a,f])], obs=z)
    # }
