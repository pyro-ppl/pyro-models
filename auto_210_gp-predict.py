# model file: ../example-models/misc/gaussian-process/gp-predict.stan
import torch
import pyro
...
def validate_data_def(data):
    ...
    assert 'y1' in data, 'variable not found in data: key=y1'
