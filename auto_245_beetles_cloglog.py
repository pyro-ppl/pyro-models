# model file: ../example-models/bugs_examples/vol2/beetles/beetles_cloglog.stan
import torch
import pyro
...
def model(data, params):
    ...
    for i in range(1, to_int(N) + 1):
        p[i - 1] = _pyro_assign(p[i - 1], _call_func("inv_cloglog", [(alpha_star + (beta * _index_select(centered_x, i - 1) ))]))
    # model block
